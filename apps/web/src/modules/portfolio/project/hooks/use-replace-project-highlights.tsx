...
import { replaceProjectHighlights, type ReplaceProjectHighlightsInput } from "../api/replace-highlights";

interface UseReplaceProjectHighlights {
	handleReplaceProjectHighlights: (data: ReplaceProjectHighlightsInput) => Promise<void>;
...
export function useReplaceProjectHighlights(): UseReplaceProjectHighlights {
	...
	const { mutateAsync: handleReplaceProjectHighlights, isPending: replaceProjectHighlightsIsPending } =
		useMutation({
