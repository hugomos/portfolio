...
const mock: Record<string, FormState> = {
	"1": {
		...
		companyWebsite: "https://empresa-x.com",
		role: "Software Engineer",
		workMode: "remote",
		startDate: new Date("2022-03-01"),
		endDate: undefined,
		highlights: [
			{ id: "h1", content: "Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor." },
			{ id: "h2", content: "Ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi." },
		],
		visible: true,
	},
	"2": {
		...
		highlights: [
			{ id: "h3", content: "Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod." },
			{ id: "h4", content: "Ut enim ad minim veniam quis nostrud exercitation ullamco laboris." },
		],
		visible: true,
	},
};
